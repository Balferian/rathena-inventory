...
// 2018-04-18bRagexeRE
	...
	packet(0x0b15, sizeof(PACKET_ZC_ACK_INVENTORY_EXPAND));
	packet(0x0b17, sizeof(PACKET_ZC_ACK_INVENTORY_EXPAND_RESULT));
	packet(0x0b18, sizeof(PACKET_ZC_INVENTORY_EXPANSION_INFO));
